...
const initialCarts = [
    { id: 1, name: "Car Battery", price: 100, quantity: 2, photo: carBattery },
    { id: 2, name: "Brake Pads", price: 50, quantity: 3, photo: brakepads },
    { id: 3, name: "Tires", price: 200, quantity: 4, photo: tires },
    { id: 4, name: "Car Battery", price: 150, quantity: 1, photo: carBattery },
    { id: 5, name: "Brake Pads", price: 75, quantity: 2, photo: brakepads },
];
...
const SellerPage = () => {
    ...
    return (
        <div className="p-8">
            ...
            <div className="overflow-y-auto max-h-120 w-full max-w-xl mx-auto">
